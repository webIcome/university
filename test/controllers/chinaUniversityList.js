...
function create(schoolList) {

    (function schoolsFn(schools) {
        let province = schools.name;
        schools = schools.school;
        (function schoolFn(university) {
            "use strict";
            if  (university.id.toString().length == 4) university.id ='0' + university.id;
            UniversityService.createUniversity({
                ...
                console.log(data);
                if (schools.length > 0) {
                    schoolFn(schools.shift())
                } else if (schoolList.length > 0){
                    schoolsFn(schoolList.shift())
                }
            })
        })(schools.shift())
    })(schoolList.shift())
